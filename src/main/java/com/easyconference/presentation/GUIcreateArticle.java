/*//GEN-FIRST:event_lbAgregarAutorMouseClicked
 * Click nbfs://nbhost/SystemFileSystem/Templates/Licenses/license-default.txt to change this license//GEN-LAST:event_lbAgregarAutorMouseClicked
...
public class GUIcreateArticle extends javax.swing.JInternalFrame {
    ...
    private void lbAgregarAutorMouseClicked(java.awt.event.MouseEvent evt) {                                            
    ...
    private void lbAgregarAutorMouseEntered(java.awt.event.MouseEvent evt) {                                            
        lbAgregarAutor.setFont(new java.awt.Font("Segoe UI Semilight", 1, 12));
    }                                           

    private void lbAgregarAutorMouseExited(java.awt.event.MouseEvent evt) {                                           
        lbAgregarAutor.setFont(new java.awt.Font("Segoe UI Semilight", 0, 12));
    }                                          

    private void lbEnviarMouseEntered(java.awt.event.MouseEvent evt) {                                      
        lbEnviar.setFont(new java.awt.Font("Segoe UI Semibold", 1, 15)); // NOI18N
    }                                     

    private void lbEnviarMouseExited(java.awt.event.MouseEvent evt) {                                     
        lbEnviar.setFont(new java.awt.Font("Segoe UI Semibold", 0, 14)); // NOI18N
    }                                    

    private void lbEnviarMouseClicked(java.awt.event.MouseEvent evt) {                                      
        if (validarCampos()) {
